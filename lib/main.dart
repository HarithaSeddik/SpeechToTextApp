...
import 'package:audio_transcription_app/data/cubits/audio_processing/audio_processing_cubit.dart';
import 'package:audio_transcription_app/data/services/api_service.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Audio Transcription App'),
        actions: [
          IconButton(
